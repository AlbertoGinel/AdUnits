...
<template>
  <div>
    ...
    <UploadLibrary
      :show="true"
      type="image"
      :images="control.availableImages.value"
      :selected-image-id="control.selectedLibraryImageId.value"
      :show-insert-button="true"
      @upload-requested="control.handleAddImage"
      @image-selected="control.handleImageSelected"
